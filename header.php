...
<head>
  ...
  <?php wp_head(); ?>
  <script src="<?php echo get_template_directory_uri() ?>/src/js/prefixfree.min.js"></script>
</head>
<body <?php body_class(); ?>>
  <nav class="nav">
    <ul>
  ...
  <div id="page">
    <header class="header">
      ...
      <img src="<?php echo get_template_directory_uri() ?>/src/img/logo.png" class="header__logo" alt="" />
    </header>
